title 'Tests to confirm postgresql works as expected'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'postgresql')

control 'core-plans-postgresql-works' do
  impact 1.0
  title 'Ensure postgresql works as expected'
  desc '
  Verify postgresql by ensuring 
